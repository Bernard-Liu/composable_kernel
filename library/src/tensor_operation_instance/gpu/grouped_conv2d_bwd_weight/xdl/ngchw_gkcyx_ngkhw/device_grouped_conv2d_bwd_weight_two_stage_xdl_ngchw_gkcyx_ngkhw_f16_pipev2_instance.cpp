                                                           ...
                                                           PassThrough>>>& instances)
{
    ...
    add_device_operation_instances(
        instances,
        device_grouped_conv_bwd_weight_two_stage_gkcyx_xdl_c_shuffle_f16_instances<
            2,
            NGCHW,
            GKCYX,
            NGKHW,
            ...
            add_device_operation_instances(
                instances,
                device_grouped_conv_bwd_weight_two_stage_gkcyx_xdl_c_shuffle_f16_irregular_instances<
                    2,
                    NGCHW,
                    GKCYX,
                    NGKHW,
