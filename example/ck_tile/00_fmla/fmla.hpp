...
struct fmha_fwd_args
{
    ...
    const void* seqlen_k_ptr; // only used if both 'seqstart_q_ptr' & 'seqstart_k_ptr' are not nullptr
...
template <ck_tile::index_t HDimQK_,
...
{
    static constexpr ck_tile::index_t HDimQK         = HDimQK_;
