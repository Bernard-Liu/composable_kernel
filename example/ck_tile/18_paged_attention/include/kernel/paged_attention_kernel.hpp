    ...
    const float* __restrict__ fp8_out_scale_ptr)
{
    ...
    constexpr int QHLOOP = DIVIDE_ROUND_UP(GQA_RATIO, 4); // each 4 lanes fetch 4 different qheads,
    ...
    constexpr int VHELOOP =
        HEAD_SIZE / WARP_SIZE; // v head_size dimension is distributed across lanes
