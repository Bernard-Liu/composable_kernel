...
using convert_dq_trait_0 =
    fmha_bwd_convert_dq_traits_<128, FmhaBwdBf16, false, false, false, false>;
...
using dot_do_o_trait_0 = fmha_bwd_dot_do_o_traits_<128, FmhaBwdBf16, false, false, false>;
...
bool run(const ck_tile::ArgParser& arg_parser)
{
    ...
    // using instance:
    // using dot_do_o_trait_ = fmha_bwd_dot_do_o_traits_<128, FmhaBwdBf16, false, false, false>;
    // using dq_dk_dv_trait_ = fmha_bwd_dq_dk_dv_traits_<128, FmhaBwdBf16, false,
    // ck_tile::BlockFmhaBwdPipelineEnum::KRKTRVR_IGLP,
    ...
    // convert_dq_trait_ = fmha_bwd_convert_dq_traits_<128, FmhaBwdBf16, false, false, false,
